...
from courses.models import Course, Tag, Review, Module, Lesson
...
class CourseAuthorSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'name', 'email', 'average_rating', 'total_courses']
...
class LessonSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'title', 'description',
                  'video_url', 'time_estimate', 'created_at']
...
class ModuleSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Module
        fields = ['id', 'title', 'lessons', 'created_at']
